(function () {
  window.NeonConfig = {
    ...
    fighters: [
      {
        ...
        info: {
          stats: { damage: 1, fireRate: 1.1, bulletCount: 1 },
      ...
      },
      {
        ...
        info: {
          stats: { damage: 1, fireRate: 1, bulletCount: 1 },
          hitSkill: "命中：造成持续伤害。",
    ...
    fighterEffects: {
      ...
      gravity: { duration: 2.8, radius: 92, pullSpeed: 92 }
    },
    rarityDefs: {
      common: { key: "common", label: "普通", css: "common", weight: 0.7 },
      rare: { key: "rare", label: "稀有", css: "rare", weight: 0.25 },
    ...
    upgradeOptions: [
      {
        ...
        weight: 1,
        valueType: "number",
        values: { common: 1, rare: 2, legendary: 3 },
        desc: "基础子弹数量 +{value}。"
      },
      {
        key: "fireRate",
